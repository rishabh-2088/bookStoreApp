...
function Navbar() {
  ...
  return (
    <>
    <div className={` max-w-screen-2x1 container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text fixed top-0 left-0 right-0 z-50 ${
      sticky
      ...
      <div className="navbar ">
        <div className='navbar-start'>
          ...
          <a className='text-2x1 font-bold cursor-Pointer'>BookStrore</a>
      </div>
